        ...
        <div className="container mx-auto px-4">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Explore our collection of high-quality {category.name.toLowerCase()} created by talented designers and artists.
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        {[5, 4, 3, 2, 1].map((rating) => (
                          <label key={rating} className="flex items-center">
                            <input type="checkbox" className="rounded border-gray-300 text-ct-blue-500 focus:ring-ct-blue-500 mr-2" />
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {["design", "digital", "template", "premium", "creative"].map((tag) => (
                    ...
                    <Button className="w-full bg-ct-blue-500 hover:bg-ct-blue-600">
                      Apply Filters
                    </Button>
                  </div>
                </CardContent>
            ...
            <div className="flex-1">
              <div className="flex justify-between items-center mb-6">
                <div>
                  <span className="text-gray-600">Showing {categoryProducts.length} results</span>
                </div>
                <div className="flex items-center">
