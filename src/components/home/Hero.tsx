...
const Hero = () => {
  return <section className="py-12 md:py-24 lg:py-32 bg-gradient-to-b from-white to-gray-50">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="space-y-4">
            ...
            <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">Art Hive is Sri Lanka's premier platform for digital content creators. Join our community to access high-quality digital products and arts or showcase your own creations.</p>
            ...
            <div className="relative">
              ...
              <div className="border-2 border-ct-teal-500 bg-gradient-to-br from-white to-ct-blue-50 rounded-xl p-2 shadow-lg">
                <div className="relative overflow-hidden rounded-lg">
                  <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=800&q=80" alt="Digital content marketplace" className="w-full max-w-md h-auto object-cover" />
